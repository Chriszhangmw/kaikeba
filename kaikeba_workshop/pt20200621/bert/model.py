...
from pt20200621.bert.bert_source_code import modeling
from pt20200621.bert.bert_source_code import optimization
from pt20200621.bert.bert_source_code import tokenization
...
flags.DEFINE_string("task_name", 'baidu_95', "The name of the task to train.")

flags.DEFINE_string("vocab_file", './pretrained_model/chinese_L-12_H-768_A-12/vocab.txt',
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    #seqence_output = model.get_sequence_output()
...
def model_fn_builder(bert_config, num_labels, init_checkpoint, learning_rate,
    ...
    def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
        ...
        # print('*****************Loss informations*****************:',total_loss, per_example_loss)
...
def main(_):
    ...
    num_warmup_steps = None  #warmup 一般使学习率先上升，然后哦平稳，再下降
    if FLAGS.do_train:
