import argparse
import os
from pt20200621.textCNN import data_loader
from pt20200621.textCNN.textcnn_model import TextCNN
...
def train(x_train, y_train, vocab_size, feature_size, save_path):
    ...
    parallel_model.compile(tf.keras.optimizers.Adam(learning_rate=args.learning_rate), loss='binary_crossentropy',
                           metrics=[micro_f1, macro_f1])
    history = parallel_model.fit(x=x_train, y=y_train, batch_size=args.batch_size, epochs=args.epochs, steps_per_epoch=200//args.batch_size,
